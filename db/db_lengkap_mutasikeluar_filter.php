...
// if($admin=="ADMIN-PLOSO"){
    while($row = mysqli_fetch_assoc($t_mutasikeluar)){
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a href="../admin/page_admin.php?nik=<?= $row["nik_mutasikeluar"]?>&admin=<?= $_GET["admin"]?>&alamat_user=<?= $_GET["alamat_user"]?>"><button class="btn btn-primary me-md-2" type="button">Kembali</button></a>
