...
$t_warga = mysqli_query($koneksi,"SELECT * FROM `t_warga` WHERE t_warga.st_penduduk='ADA' AND t_warga.nik='$nik' 
 AND t_warga.kondisi='HIDUP' ");
$warga = mysqli_fetch_assoc($t_warga);
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h4 class="m-0 font-weight-bold text-primary">Form Edit Pendataan Penduduk Desa Gluranploso</h4>
                        ...
                        <form action="../update_data/update_warga.php?nik=<?= $warga["nik"]?>&admin=<?= $_GET["admin"]?>&alamat_user=<?= $_GET["alamat_user"]?>"  method="POST" style="margin-left: 15%;">
                            ...
                            <div id="identitas" style="margin-left: 2%; text-align:justify; width:80%;" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['nik']?>" type="text" name="nik_baru" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>   
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['nama']?>" type="text" name="nama" class="form-control" placeholder="Isi dengan huruf kapital" style="margin-bottom: 5px;" required>
                                </div> 
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="jk">
                                            <option selected><?= $warga['jk']?></option>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['tempat_lahir']?>" type="text" name="tempat_lahir" class="form-control" placeholder="Isi dengan huruf kapital" style="margin-bottom: 5px;" required>
                                </div>  
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['tanggal_lahir']?>" type="date"  name="tanggal_lahir" class="form-control" placeholder="yyyy-mm-dd" style="margin-bottom: 5px;" required>
                                </div> 
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="pendidikan">
                                            <option selected><?= $warga['pendidikan']?></option>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="pekerjaan">
                                            <option selected><?= $warga['pekerjaan']?></option>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="kawin">
                                            <option selected><?= $warga['kawin']?></option>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="st_keluarga">
                                            <option selected><?= $warga['st_keluarga']?></option>
                            ...
                            <h5 class=" m-0 ml-3 mt-4 font-weight-bold text-dark" >2. ALAMAT PENDUUDK :</h5>
                            <div id="identitas" style="margin-left: 2%; text-align:justify; width:80%;" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['no_kk']?>" type="text" name="no_kk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="alamat">
                                            <option selected><?= $warga['alamat']?></option>
                                                <option>PLOSO</option>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['rt']?>" type="text" name="rt" class="form-control" placeholder="3 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['rw']?>" type="text" name="rw" class="form-control" placeholder="3 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                            </div>

                            
                            <h5 class=" m-0 ml-3 mt-4 font-weight-bold text-dark" >3. KETERANGAN LAIN :</h5>
                            <div id="identitas" style="margin-left: 2%; text-align:justify; width:80%;" >

                                <label for="st_mutasi" class="mb-1 mt-2" >Status Mutasi</label>
                                <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text " style="height: 38px;">
                                                <i class="fas fa-address-card"></i>
                                        ...
                                        <select class="form-control form-control" name="st_mutasi">
                                            <option selected><?= $warga['st_mutasi']?></option>
                                ...
                                <label for="st_penduduk" class="mb-1 mt-2" >Status Keberadaan</label>
                                <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text " style="height: 38px;">
                                                <i class="fas fa-address-card"></i>
                                        ...
                                        <select class="form-control form-control" name="st_penduduk">
                                            <option selected><?= $warga['st_penduduk']?></option>
                                                <option>ADA</option>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="kondisi">
                                            <option selected><?= $warga['kondisi']?></option>
                                                <option>HIDUP</option>
                            ...
                            <div class="form-group row" style="margin-top: 1%; text-align:right; ">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-danger" name="edit_warga">Simpan</button>
                                    <a href="../admin/data_penduduk.php?admin=<?= $_GET["admin"]?>&alamat_user=<?= $_GET["alamat_user"]?>"><button type="button" class="btn btn-primary" name="batal">Kembali</button></a>
                                </div>
                            </div>
