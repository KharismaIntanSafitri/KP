                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h4 class="m-0 font-weight-bold text-primary">Form Pendataan Penduduk Desa Gluranploso</h4>
                        ...
                        <form action="../update_data/update_mutasikeluar.php?nik=<?= $warga["nik_mutasikeluar"]?>&admin=<?= $_GET["admin"]?>&alamat_user=<?= $_GET["alamat_user"]?>"  method="POST" style="margin-left: 15%;">
                            ...
                            <div id="identitas" style="margin-left: 2%; text-align:justify; width:80%;" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['nik_mutasikeluar']?>" type="text" name="nik_baru" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>   
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['nama_mutasikeluar']?>" type="text" name="nama" class="form-control" placeholder="Isi dengan huruf kapital" style="margin-bottom: 5px;" required>
                                </div> 
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="jk">
                                            <option selected><?= $warga['jk_mutasikeluar']?></option>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['tempat_lahir_mutasikeluar']?>" type="text" name="tempat_lahir" class="form-control" placeholder="Isi dengan huruf kapital" style="margin-bottom: 5px;" required>
                                </div>  
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['tanggal_lahir_mutasikeluar']?>" type="date"  name="tanggal_lahir" class="form-control" placeholder="yyyy-mm-dd" style="margin-bottom: 5px;" required>
                                </div> 
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="pendidikan">
                                            <option selected><?= $warga['pendidikan_mutasikeluar']?></option>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="pekerjaan">
                                            <option selected><?= $warga['pekerjaan_mutasikeluar']?></option>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="kawin">
                                            <option selected><?= $warga['kawin_mutasikeluar']?></option>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="st_keluarga">
                                            <option selected><?= $warga['st_keluarga_mutasikeluar']?></option>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="agama">
                                            <option selected><?= $warga['agama_mutasikeluar']?></option>
                                                <option>ISLAM</option>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['kk_mutasikeluar']?>" type="text" name="no_kk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                            </div>
                            ...
                            <div id="identitas" style="margin-left: 2%; text-align:justify; width:80%;" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['provinsi_tujuankeluar']?>" type="text" name="provinsi_tujuanmasuk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['kab_tujuankeluar']?>" type="text" name="kab_tujuanmasuk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['kec_tujuankeluar']?>" type="text" name="kec_tujuanmasuk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['kel_tujuankeluar']?>" type="text" name="kel_tujuanmasuk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="dsn_tujuanmasuk">
                                            <option selected><?= $warga['dsn_tujuankeluar']?></option>
                                                <option>PLOSO</option>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['rt_tujuankeluar']?>" type="text" name="rt_tujuanmasuk" class="form-control" placeholder="3 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['rw_tujuankeluar']?>" type="text" name="rw_tujuanmasuk" class="form-control" placeholder="3 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                            </div>
                            ...
                            <div id="identitas" style="margin-left: 2%; text-align:justify; width:80%;" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['provinsi_asalkeluar']?>" type="text" name="provinsi_asalmasuk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['kab_asalkeluar']?>" type="text" name="kab_asalmasuk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['kec_asalkeluar']?>" type="text" name="kec_asalmasuk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['kel_asalkeluar']?>" type="text" name="kel_asalmasuk" class="form-control" placeholder="16 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="dsn_asalmasuk">
                                            <option selected><?= $warga['dsn_asalkeluar']?></option>
                                                <option>PLOSO</option>
                                                <option>BENGKELO KIDUL</option>
                                                <option>GLURAN</option>
                                                <option>LEPIT</option>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['rt_tujuankeluar']?>" type="text" name="rt_asalmasuk" class="form-control" placeholder="3 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?= $warga['rw_asalkeluar']?>" type="text" name="rw_asalmasuk" class="form-control" placeholder="3 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                            </div>
                            ...
                            <div id="identitas" style="margin-left: 2%; text-align:justify; width:80%;" >
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="jenis_mutasikeluar">
                                            <option selected><?= $warga['jenis_mutasikeluar']?></option>
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form-control form-control" name="kondisi">
                                            <option selected><?= $warga['kondisi_keluar']?></option>
                                                <option>HIDUP</option>
                            ...
                            <div class="form-group row" style="margin-top: 1%; text-align:right; ">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-primary" name="edit_mutasikeluar">Tambah</button>
                                    <a href="../admin/data_mutasikeluar.php?admin=<?= $_GET["admin"]?>&alamat_user=<?= $_GET["alamat_user"]?>"><button type="button" class="btn btn-primary" name="batal">Kembali</button></a>
                                </div>
                            </div>
