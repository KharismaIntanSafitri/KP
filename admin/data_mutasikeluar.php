                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h4 class="m-0 font-weight-bold text-primary">Data Mutasi Keluar Penduduk Desa Gluranploso</h4>
                                <div>
                                        <form action="../admin/data_mutasikeluar.php?admin=<?= $_GET["admin"]?>&alamat_user=<?= $_GET["alamat_user"]?>" method="POST" >
                        ...
                        <div  style="margin: 2%;">
                         <!-- Awal Isi Konten -->
                            ...
                            <table class="table table-bordered " id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody >
                                    <?php
                                    include '../db/db_data_mutasikeluar.php'
                                    ?>
                                </tbody>
                                <?php 
                                if(isset($_POST["cari"])){
