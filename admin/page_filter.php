                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h4 class="m-0 font-weight-bold text-primary">Form Pendataan Penduduk Desa <span><?= $bb?></span></h4>
                                <div>
                                    <a href="../input_data/input_warga.php" class="btn btn-primary">Tambah Data Penduduk</a>
                                    <div class="btn-group" role="group">
                                        <button  type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Tambah Data Mutasi
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        <a class="dropdown-item" href="../input_data/input_mutasi_keluar.php" id="mutasi_keluar">Mutasi Keluar</a>
                                        <a class="dropdown-item" href="../input_data/input_mutasi_masuk.php" id="mutasi_masuk">Mutasi Masuk</a>
                                        </div>
                                    </div>
