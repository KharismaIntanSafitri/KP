                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h4 class="m-0 font-weight-bold text-primary">Form  Mutasi Keluar Penduduk Desa Gluranploso</h4>
                        ...
                        <form action="../proses_data/tambah_mutasi_keluar.php?admin=<?= $_GET["admin"]?>&alamat_user=<?= $_GET["alamat_user"]?>" method="POST" style="margin-left: 15%;">
                            ...
                            <div id="identitas" style="margin-left: 2%; text-align:justify; width:80%;" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" placeholder="Isi dengan huruf kapital" style="margin-bottom: 5px;" required value="<?php $nama ?>">
                                </div> 
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="tgl_mutasi" class="form-control" placeholder="Isi dengan huruf kapital" style="margin-bottom: 5px;" required value="<?php $nama ?>">
                                </div> 
                            ...
                            <div id="identitas" style="margin-left: 2%; text-align:justify; width:80%;" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="rt_tujuan" class="form-control" placeholder="3 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="rw_tujuan" class="form-control" placeholder="3 Digit angka" style="margin-bottom: 5px;" required>
                                </div>
